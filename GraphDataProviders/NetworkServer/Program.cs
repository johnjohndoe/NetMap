...
class Program
{
    ...
    )
    {
        ...
        String sCredentialsScreenName = null;
        String sCredentialsPassword = null;
        ...
        Console.WriteLine(GettingNetworkMessage);
    ...
    /// Message to show before getting the network.

    private const String GettingNetworkMessage =
        "Getting the specified network...\r\n"
        ;
}
