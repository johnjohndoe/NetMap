...
public class NetworkConfigurationFileParserTest : Object
{
    ...
    TestGetTwitterSearchNetworkConfiguration()
    {
        ...
        m_oNetworkConfigurationFileParser.GetTwitterSearchNetworkConfiguration(
            ...
            out sCredentialsScreenName, out sCredentialsPassword,
        ...
        Assert.IsNull(sCredentialsScreenName);
        Assert.IsNull(sCredentialsPassword);
    ...
    TestGetTwitterSearchNetworkConfiguration2()
    {
        ...
        WriteSampleNetworkConfigurationFile(
            "<CredentialsScreenName></CredentialsScreenName>",
            "<CredentialsScreenName>JohnDoe</CredentialsScreenName>",
            "<CredentialsPassword></CredentialsPassword>",
            "<CredentialsPassword>The Password</CredentialsPassword>"
            );
        ...
        Assert.AreEqual("JohnDoe", sCredentialsScreenName);
        Assert.AreEqual("The Password", sCredentialsPassword);
    }
    ...
    {
        // Missing CredentialsPassword.

        WriteSampleNetworkConfigurationFile(
            "<CredentialsScreenName></CredentialsScreenName>",
            "<CredentialsScreenName>Xyz</CredentialsScreenName>"
            );
    ...
    //*************************************************************************
    //  Method: TestGetTwitterSearchNetworkConfigurationBad9()
    //
    /// <summary>
    /// Tests the GetTwitterSearchNetworkConfiguration() method.
    /// </summary>
    ...
    public void
    TestGetTwitterSearchNetworkConfigurationBad9()
    {
    ...
    TestGetTwitterUserNetworkConfiguration()
    {
        ...
        m_oNetworkConfigurationFileParser.GetTwitterUserNetworkConfiguration(
            ...
            out iMaximumPeoplePerRequest, out sCredentialsScreenName,
            out sCredentialsPassword, out sNetworkFileFolder,
    ...
    //*************************************************************************
    //  Method: TestGetTwitterUserNetworkConfiguration2()
    //
    /// <summary>
    /// Tests the GetTwitterUserNetworkConfiguration() method.
    /// </summary>
    ...
    public void
    TestGetTwitterUserNetworkConfiguration2()
    {
        // Credentials specified.
    ...
    //*************************************************************************
    //  Method: TestGetTwitterUserNetworkConfigurationBad11()
    //
    /// <summary>
    /// Tests the GetTwitterUserNetworkConfiguration() method.
    /// </summary>
    ...
    public void
    TestGetTwitterUserNetworkConfigurationBad11()
    {
        // Bad NetworkFileFormats.
