...
//
/// <summary>
///	Base class for most classes in the <see cref="Microsoft.NetMap.Adapters" />
/// namespace.
/// </summary>
//*****************************************************************************

public class AdapterBase : NetMapBase
{
    //*************************************************************************
	...
	///
	/// <para>
	/// The <see cref="NetMapBase" /> implementation of this property cannot be
