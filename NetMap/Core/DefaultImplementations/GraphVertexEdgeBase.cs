...
public class GraphVertexEdgeBase :
	NetMapBase, IIdentityProvider, IMetadataProvider
{
    //*************************************************************************
	...
	///
	/// <para>
	///	The core NetMap system does not enforce uniqueness of names.  It is
	...
	/// objects of the same type for the duration of the process in which NetMap
	/// is running.
	///
	/// <para>
	...
	)
	{
		...
		// a NetMap method and so they can't be prohibited.
	}
