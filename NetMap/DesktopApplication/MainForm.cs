...
public partial class MainForm : DesktopApplicationForm
{
	...
	)
	{
		...
		//
		// 2. The NetMapControl.OnResize() method gets called.
		//
		// 3. NetMapControl.OnResize() starts an asynchronous drawing operation.
		//
		...
		//    (NetMapControl) may or may not still exist when the event fires.
		//
	...
	)
    {
		...
		// NetMapControl in its event handler.
    }
	...
	protected static readonly String HelpFileName =
		"Documents\\Help\\NetMapDesktopApplication.chm";
