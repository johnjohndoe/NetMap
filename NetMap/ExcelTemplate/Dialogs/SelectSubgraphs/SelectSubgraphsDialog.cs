...
/// of the graph in the NetMapControl is handled by the dialog.
/// </remarks>
//*****************************************************************************
...
public partial class SelectSubgraphsDialog : ExcelTemplateForm
{
	...
	: this()
	{
		...
		m_aoInitiallySelectedVertices =
			( IVertex [] )netMapControl.SelectedVertices.Clone();
	...
	)
    {
		...
		NetMapControlUtil.SelectSubgraphs(oNetMapControl, aoVertices,
	...
	)
    {
		...
		SelectSubgraphs(
			m_oNetMapControl, m_oClickedVertex,
			m_oSelectSubgraphsDialogUserSettings.UseAllSelectedVertices,
			m_oSelectSubgraphsDialogUserSettings.Levels,
			m_oSelectSubgraphsDialogUserSettings.SelectConnectingEdges
			);
	...
	/// The NetMapControl whose vertices and edges should be selected.
