...
//*****************************************************************************
//  Class: ClusterVerticesTableColumnWidths
//
/// <summary>
/// Provides the widths of the dynamically-added columns in the
/// vertex-to-cluster table.
/// </summary>
///
/// <remarks>
/// Most dynamically-added columns are auto-sized and don't need an explicit
...
public static class ClusterVerticesTableColumnWidths
{
	// (There are no such columns.)
}
