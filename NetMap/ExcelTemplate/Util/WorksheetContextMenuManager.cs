...
/// .NetMap menu items to the Excel context menus, including handling and
...
public class WorksheetContextMenuManager : Object
{
	...
	)
	{
		...
		// Add a top-level .NetMap popup menu item.
	...
	/// Where the added top-level .NetMap popup menu item gets stored.
	/// </param>
	//*************************************************************************
	...
	//
	/// <summary>
	/// Adds a top-level .NetMap popup menu item to the context menu that
	...
	///
	/// <returns>
	/// The new .NetMap top-level popup menu item.
	/// </returns>
	//*************************************************************************
	...
	RemoveContextMenuItems()
	{
        ...
        try
        {
			// Delete the top-level .NetMap popup menu item, which also deletes
