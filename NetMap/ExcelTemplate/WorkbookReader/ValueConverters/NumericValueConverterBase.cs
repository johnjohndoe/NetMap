...
/// workbook to and from numeric values in the NetMap graph.
/// </summary>
//*****************************************************************************
...
public class NumericValueConverterBase : Object
{
	...
	/// Minimum value in the NetMap graph.
    /// </param>
	///
    /// <param name="maximumGraphValue">
	/// Maximum value in the NetMap graph.  Must be greater than <paramref
    ...
    //
    /// <summary>
	/// Converts an Excel workbook value to a value suitable for use in a NetMap
	/// graph.
    /// </summary>
    ///
    ...
    ///
    /// <returns>
	/// A value suitable for use in a NetMap graph.  The value is pinned to the
	...
	/// Maximum value in the NetMap graph.
