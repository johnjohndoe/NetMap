...
/// workbook and coordinates used in the NetMap graph.
/// </summary>
//*****************************************************************************
...
public class VertexLocationConverter : Object
{
    ...
    //
    /// <summary>
	/// Converts a vertex location from Excel workbook coordinates to NetMap
	/// graph coordinates.
    /// </summary>
    ///
    ...
    ///
    /// <returns>
	/// A PointF suitable for use as an IVertex.Location value in a NetMap
	/// graph.
    /// </returns>
    //*************************************************************************
    ...
    //
    /// <summary>
	/// Converts a vertex location from NetMap graph coordinates to Excel
	/// workbook coordinates.
    /// </summary>
    ///
    /// <param name="graphLocation">
    /// IVertex.Location value from a NetMap graph.
    /// </param>
	///
    /// <param name="workbookX">
