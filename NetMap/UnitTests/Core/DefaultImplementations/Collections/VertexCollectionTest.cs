...
public class VertexCollectionTest : Object
{
    ...
    TestToString8()
    {
		...
		String sExpectedValue =
			...
			+ "\tID = " + aoVertices[0].ID.ToString(NetMapBase.Int32Format)
			+ "\r\n"

			+ "\tID = " + aoVertices[1].ID.ToString(NetMapBase.Int32Format)
			+ "\r\n"

			+ "\tID = " + aoVertices[2].ID.ToString(NetMapBase.Int32Format)
			+ "\r\n"

			+ "\tID = " + aoVertices[3].ID.ToString(NetMapBase.Int32Format)
			+ "\r\n"
			;
