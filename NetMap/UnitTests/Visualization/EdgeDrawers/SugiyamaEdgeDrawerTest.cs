...
{
//*****************************************************************************
//  Class: SugiyamaEdgeDrawerTest
//
/// <summary>
/// This is a Visual Studio test fixture for the <see
/// cref="SugiyamaEdgeDrawer" /> class.
/// </summary>
///
/// <remarks>
/// This fixture repeats most of the tests from EdgeDrawerTest, then adds tests
/// for the functionality that SugiyamaEdgeDrawer adds to VertexDrawer.
/// </remarks>
//*****************************************************************************

[TestClassAttribute]

public class SugiyamaEdgeDrawerTest : Object
{
    //*************************************************************************
    //  Constructor: SugiyamaEdgeDrawerTest()
    //
    /// <summary>
    /// Initializes a new instance of the <see cref="SugiyamaEdgeDrawerTest" />
	/// class.
    /// </summary>
    //*************************************************************************

    public SugiyamaEdgeDrawerTest()
    {
        m_oEdgeDrawer = null;
		m_oEdge = null;
		m_oBitmap = null;
    ...
    SetUp()
    {
        m_oEdgeDrawer = new SugiyamaEdgeDrawer();
    ...
    TestWidthBad()
    {
		...
		catch (ApplicationException oApplicationException)
		{
			Assert.AreEqual( String.Format(
				...
				+ "SugiyamaEdgeDrawer.Width: Must be between {0} and {1}."
				,
				EdgeDrawer.MinimumWidth,
				EdgeDrawer.MaximumWidth
				)
    ...
    TestSelectedWidthBad()
    {
		...
		catch (ApplicationException oApplicationException)
		{
			Assert.AreEqual( String.Format(
				...
				"Microsoft.NetMap.Visualization."
				+ "SugiyamaEdgeDrawer.SelectedWidth: Must be between {0}"
				+ " and {1}."
				,
				EdgeDrawer.MinimumWidth,
				EdgeDrawer.MaximumWidth
    ...
    TestDrawEdge()
    {
		foreach ( Int32 iVertex1X in new Int32 [] {1} )

		foreach ( Int32 iVertex1Y in new Int32 [] {1} )

		foreach ( Int32 iVertex2X in new Int32 [] {49} )

		foreach ( Int32 iVertex2Y in new Int32 [] {49} )
    ...
    TestDrawEdgeBad()
    {
		...
		catch (ArgumentNullException oArgumentNullException)
		{
			Assert.AreEqual(
				...
				"Microsoft.NetMap.Visualization."
				+ "SugiyamaEdgeDrawer.DrawEdge: edge argument can't be"
				+ " null.\r\n"
				+ "Parameter name: edge"
				,
    ...
    TestDrawEdgeBad2()
    {
		...
		catch (ArgumentNullException oArgumentNullException)
		{
			Assert.AreEqual(
				...
				"Microsoft.NetMap.Visualization."
				+ "SugiyamaEdgeDrawer.DrawEdge: drawContext argument can't be"
				+ " null.\r\n"
	...
	/// true to store metadata on the edge that specifies the curve to draw.
	/// </param>
    //*************************************************************************
	...
	)
    {
		...
		m_oEdge = CreateEdge(iVertex1X, iVertex1Y, iVertex2X, iVertex2Y,
			bSelected);
        ...
        if (bSetMetadata)
        {
            m_oEdge.SetValue( ReservedMetadataKeys.SugiyamaCurvePoints,
				new PointF [] {
					new PointF (0, 0),
					new PointF (4, 5),
					new PointF (14, 15),
            ...
            m_oEdge.SetValue(
                ReservedMetadataKeys.SugiyamaEndpoint, new PointF(40, 45)
                );
        }
        else
        {
            m_oEdge.ParentGraph.RemoveKey(
				ReservedMetadataKeys.SugiyamaCurvePoints);
	...
	protected const String TestImageRelativeDirectory =
		"Visualization\\EdgeDrawers\\TestImageFiles\\SugiyamaEdgeDrawer";
