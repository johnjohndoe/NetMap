...
{
//*****************************************************************************
//  Class: BrandesFastCentralities
//
/// <summary>
/// Stores the centrality metrics that are calculated by <see
/// cref="BrandesFastCentralities" /> for one vertex.
/// </summary>
//*****************************************************************************

public class BrandesFastCentralities : Object
{
    //*************************************************************************
    //  Constructor: BrandesFastCentralities()
    //
    /// <summary>
    /// Initializes a new instance of the <see
    /// cref="BrandesFastCentralities" /> class.
    /// </summary>
    //*************************************************************************

    public BrandesFastCentralities()
    {
