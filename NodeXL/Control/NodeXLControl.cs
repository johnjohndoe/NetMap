...
//
/// <summary>
/// NodeXL graph-drawing control.
/// </summary>
///
/// <remarks>
/// <see cref="NodeXLControl" /> is one of several classes provided with the
/// NodeXL system that draw a graph, which is a set of vertices connected by
/// edges.
///
/// <para>
...
/// <term>Features</term>
/// <term>Required NodeXL Assemblies</term>
/// </listheader>
///
/// <item>
...
///
/// <item>
/// <term><see cref="NodeXLControl" /></term>
/// <term>
...
///
/// <para>
/// Using <see cref="NodeXLControl" /> in an application involves two steps:
/// <list type="bullet">
///
/// <item>
/// <description>
...
public partial class Form1 : Form
{
    public Form1()
    {
        ...
        nodeXLControl1.VertexDrawer = new PerVertexWithLabelDrawer();
        ...
        nodeXLControl1.EdgeDrawer = new PerEdgeWithLabelDrawer();
...
public class NodeXLControl : Panel
{
    //*************************************************************************
    //  Constructor: NodeXLControl()
    //
    /// <summary>
    /// Initializes a new instance of the NodeXLControl class.
    /// </summary>
    //*************************************************************************
	...
	)
	{
		...
		if (eDrawType == DrawType.AsyncLayoutAndDraw)
		{
			...
			// applications, this works fine.  When NodeXLControl is used within
			...
			// communicate with NodeXLControl on the wrong thread.  Why does
		...
		else if (eDrawType == DrawType.DrawOnly)
		{
			FireDrawingGraph();
		}
	...
	)
	{
		...
		// TODO: This doesn't work when NodeXLControl is used in ExcelTemplate.
