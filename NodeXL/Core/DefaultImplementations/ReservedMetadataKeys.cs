...
//
/// <summary>
/// Contains metadata keys that are reserved for internal use by the NodeXL
/// system.
/// </summary>
///
/// <remarks>
...
public static class ReservedMetadataKeys : Object
{
    ...
    /// vertex's tooltip when using the NodeXLControl.  The value must be a
    /// String.
	///
	/// <para>
	/// For tooltips to be visible, you must set NodeXLControl.UseToolTips to
	...
	/// Microsoft.NodeXL.Visualization.HitTestArea object that defines the area
	...
	/// <summary>
	/// Key added to a vertex or edge to control its visibility.  The value is
	/// one of the <see cref="VisibilityKeyValue" /> values.
	///
	/// <para>
...
/// edge.  For a vertex, it also determines vertex's hit-testing behavior.
/// </remarks>
//*****************************************************************************
...
{
    /// <summary>
    /// The vertex or edge is drawn normally.  For a vertex, the vertex can be
	/// hit-tested if the <see cref="ReservedMetadataKeys.HitTestArea" /> key
	/// is also present.
    /// </summary>
	...
	/// layout.  For a vertex, the vertex can't be hit-tested, even if the <see
	/// cref="ReservedMetadataKeys.HitTestArea" /> key is also present.
	///
	/// <para>
	...
	/// it has been filtered with a dynamic filter.  For a vertex, the vertex
	/// can't be hit-tested, even if the <see
	/// cref="ReservedMetadataKeys.HitTestArea" /> key is also present.
	///
	/// <para>
	/// Any <see cref="ReservedMetadataKeys.PerAlpha" /> key is ignored.
