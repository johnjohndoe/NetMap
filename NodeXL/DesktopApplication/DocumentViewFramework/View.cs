...
public partial class View : DesktopApplicationForm
{
	...
	Document
	{
		...
		set
		{
			...
			// Assign the graph to the NodeXLControl and specify the layout to
			// use.
    ...
    IsDrawing
    {
        get
        {
			...
			return (oNodeXLControl.IsDrawing);
        }
    }
	...
	RefreshLayout()
	{
		...
		// Force the NodeXLControl to lay out the graph again.

		oNodeXLControl.ForceLayout();
	}
	...
	//
	/// <summary>
	///	Applies the user's graph settings to the NodeXLControl.
	/// </summary>
	///
	...
	)
	{
		...
		oGraphSettings.TransferToNodeXLControl(this.oNodeXLControl);
	}

    //*************************************************************************
    //  Method: SetNodeXLControlLayout()
    //
    /// <summary>
	/// Sets the layout used by the NodeXLControl.
    /// </summary>
    ///
	/// <remarks>
	/// Important: The call to this method must be surrounded by
	/// NodeXLControl.BeginUpdate() and NodeXLControl.EndUpdate() to avoid
    ...
    SetNodeXLControlLayout()
	{
        ...
        // Set the layout-related properties on the NodeXLControl.

		m_oLayoutManager.ApplyLayoutToNodeXLControl(
			oNodeXLControl, m_oGraphSettings.Margin);
	...
	)
    {
        ...
        oGraphInfoViewer.SetSelection(
			oNodeXLControl.SelectedVertices, oNodeXLControl.SelectedEdges
			);
    }
	...
	)
    {
		...
		oNodeXLControl.SetSelected(requestSelectionEventArgs.Vertices,
