...
//*****************************************************************************
//  Class: ImportEdgesFromWorkbookDialogUserSettings
//
/// <summary>
/// Stores the user's settings for the <see
/// cref="ImportEdgesFromWorkbookDialog" />.
/// </summary>
///
/// <remarks>
...
[ SettingsGroupNameAttribute("ImportEdgesFromWorkbookDialog") ]

public class ImportEdgesFromWorkbookDialogUserSettings : FormSettings
{
    //*************************************************************************
    //  Constructor: ImportEdgesFromWorkbookDialogUserSettings()
    //
    /// <summary>
    /// Initializes a new instance of the <see
