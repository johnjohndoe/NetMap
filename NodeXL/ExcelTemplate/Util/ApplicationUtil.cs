...
public static class ApplicationUtil
{
	...
	)
    {
		...
		latestVersionFileMajorPart =
			Int32.Parse(oMatch.Groups["FileMajorPart"].Value);

		latestVersionFileMinorPart =
			Int32.Parse(oMatch.Groups["FileMinorPart"].Value);

		latestVersionFileBuildPart =
			Int32.Parse(oMatch.Groups["FileBuildPart"].Value);

		latestVersionFilePrivatePart =
			Int32.Parse(oMatch.Groups["FilePrivatePart"].Value);
    }
