...
public static class WorkbookSchemeAutoFiller : Object
{
    ...
    )
    {
        ...
        try
        {
            ...
            AutoFillByVertexCategory(oEdgeTable, oVertexTable,
    ...
    )
    {
        ...
        try
        {
            ...
            TableColumnMapper.MapToNumericRange(oEdgeTable,
                edgeWeightColumnName, EdgeTableColumnNames.Width, false, false,
                0, 0, EdgeWidthConverter.MinimumWidthWorkbook,
                EdgeWidthConverter.MaximumWidthWorkbook, false);
    ...
    )
    {
        ...
        try
        {
            ...
            TableColumnMapper.MapToColor(oEdgeTable, edgeTimestampColumnName,
                EdgeTableColumnNames.Color, false, false, 0, 0,
                Color.FromArgb(0, 11, 96), Color.FromArgb(0, 134, 227),
                false);
    ...
    )
    {
        ...
        Int32 iColorIndex = iSchemeIndex % iColors;
        Int32 iShapeAndRadiusIndex = (iSchemeIndex / iColors) % iShapes;

        oColor = aoColors[iColorIndex];
        eShape = aeShapes[iShapeAndRadiusIndex];
        fRadius = afRadii[iShapeAndRadiusIndex];
    }
