...
public class TwitterVertex : Object
{
    ...
    )
    {
        ...
        m_sStatusForAnalysisDateUtc = null;
    ...
    //*************************************************************************
    //  Property: StatusForAnalysisDateUtc
    //
    /// <summary>
    ...
    ///
    /// <value>
    /// The date of the status text to use for relationship analysis, as a UTC
    /// string.  Can be null or empty.  The default value is null.
    /// </value>
    ///
    /// <remarks>
    ...
    public String
    StatusForAnalysisDateUtc
    {
        get
        {
            AssertValid();

            return (m_sStatusForAnalysisDateUtc);
        }

        set
        {
            m_sStatusForAnalysisDateUtc = value;
    ...
    protected String m_sStatusForAnalysisDateUtc;
}
