...
public class TriangularHitTestArea : HitTestArea
{
    //*************************************************************************
    //  Constructor: TriangularHitTestArea()
    //
    /// <summary>
    /// Initializes a new instance of the <see cref="TriangularHitTestArea" />
	/// class.
    /// </summary>
	///
    /// <param name="center">
    ...
    GetRegion()
	{
		...
		oGraphicsPath.AddPolygon(GraphicsUtil.TriangleFromCenterAndHalfWidth(
