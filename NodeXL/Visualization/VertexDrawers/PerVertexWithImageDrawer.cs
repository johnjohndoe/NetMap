...
public class PerVertexWithImageDrawer : PerVertexDrawer
{
    ...
    )
	{
		...
		// The image will be drawn without scaling, centered on the vertex.
		...
		// If the vertex isn't selected and it has an alpha component, don't
		// draw the image.  TODO: Draw the image using the alpha component.

		if (bDrawSelected || oActualColor.A == 255)
		{
		...
		DrawVertexOutline( drawContext, oImageRectangle, oActualColor,
			bDrawSelected);
